...
def dish():
    ...
    storage.child(path_on_cloud).download(filename="dscehack.jpg",path=os.path.basename(path_on_cloud))
    time.sleep(4)
    ...
    answer =predict_image('dscehack.jpg',model)
